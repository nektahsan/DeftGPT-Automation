...
// exports.config = {
//   runner: "local",
//   path: "/", // Default WebDriver path for ChromeDriver
//   port: 9515, // Default WebDriver port for ChromeDriver

//   // Define test specs (Feature files location)
...
//       acceptInsecureCerts: true,
//       "goog:chromeOptions": {
//         args: ["--headless", "--disable-gpu"], // Optional: Run in headless mode for CI
//       },
//     },
//   ],
...
//   // Services
//   services: ["chromedriver"], // Use the correct WDIO service
...
//   cucumberOpts: {
//     require: fs
//       .readdirSync(path.join(__dirname, "./features/step-definitions"))
...
const path = require("path");
const fs = require("fs");
require("dotenv").config(); // :white_check_mark: Load environment variables
exports.config = {
  runner: "local",
  // Web automation doesn't require Appium
  path: "/",
